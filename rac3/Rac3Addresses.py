...
RAC3_ITEM_DATA_TABLE: dict[str, RAC3DATATABLE] = {
    # Weapons
    RAC3ITEM.SHOCK_BLASTER: RAC3DATATABLE(0x00142CC7, 39, 0x0014288C, 30),
    RAC3ITEM.NITRO_LAUNCHER: RAC3DATATABLE(0x00142D17, 19, 0x001429CC, 8),
    RAC3ITEM.N60_STORM: RAC3DATATABLE(0x00142CCF, 47, 0x001428AC, 150),
    RAC3ITEM.PLASMA_WHIP: RAC3DATATABLE(0x00142D1F, 27, 0x001429EC, 25),
    RAC3ITEM.INFECTOR: RAC3DATATABLE(0x00142CD7, 55, 0x001428CC, 15),
    RAC3ITEM.SUCK_CANNON: RAC3DATATABLE(0x00142D27, 35, 0x00000000, 0),
    RAC3ITEM.SPITTING_HYDRA: RAC3DATATABLE(0x00142CE7, 71, 0x0014290C, 15),
    RAC3ITEM.AGENTS_OF_DOOM: RAC3DATATABLE(0x00142CF7, 87, 0x0014294C, 6),
    RAC3ITEM.FLUX_RIFLE: RAC3DATATABLE(0x00142D0F, 11, 0x001429AC, 10),
    RAC3ITEM.ANNIHILATOR: RAC3DATATABLE(0x00142CDF, 63, 0x001428EC, 20),
    RAC3ITEM.HOLO_SHIELD: RAC3DATATABLE(0x00142D07, 3, 0x0014298C, 8),
    RAC3ITEM.DISK_BLADE: RAC3DATATABLE(0x00142CEF, 79, 0x0014292C, 25),
    RAC3ITEM.RIFT_INDUCER: RAC3DATATABLE(0x00142CFF, 95, 0x0014296C, 8),
    RAC3ITEM.QWACK_O_RAY: RAC3DATATABLE(0x00142D2F, 43, 0x00000000, 0),
    RAC3ITEM.RY3N0: RAC3DATATABLE(0x00142D37, 51, 0x00142A4C, 25),
    RAC3ITEM.MINI_TURRET: RAC3DATATABLE(0x00142CB5, 21, 0x00142844, 10),
    RAC3ITEM.LAVA_GUN: RAC3DATATABLE(0x00142CB1, 17, 0x00142834, 150),
    RAC3ITEM.SHIELD_CHARGER: RAC3DATATABLE(0x00142CB6, 22, 0x00142848, 3),
    RAC3ITEM.BOUNCER: RAC3DATATABLE(0x00142CB3, 19, 0x0014283C, 10),
    RAC3ITEM.PLASMA_COIL: RAC3DATATABLE(0x00142CB0, 16, 0x00142830, 15),
    # Gadgets
    RAC3ITEM.HELI_PACK: RAC3DATATABLE(0x00142CA2, 0),
    RAC3ITEM.THRUSTER_PACK: RAC3DATATABLE(0x00142CA3, 0),
    RAC3ITEM.HACKER: RAC3DATATABLE(0x00142CB4, 0),
    RAC3ITEM.HYPERSHOT: RAC3DATATABLE(0x00142CAB, 11),
    RAC3ITEM.REFRACTOR: RAC3DATATABLE(0x00142CB2, 18),
    RAC3ITEM.TYHRRA_GUISE: RAC3DATATABLE(0x00142CBE, 30),
    RAC3ITEM.GRAV_BOOTS: RAC3DATATABLE(0x00142CAD, 0),
    RAC3ITEM.BOLT_GRABBER: RAC3DATATABLE(0x00142CA7, 0),
    RAC3ITEM.BOX_BREAKER: RAC3DATATABLE(0x00142CBA, 0),
    RAC3ITEM.MAP_O_MATIC: RAC3DATATABLE(0x00142CA5, 0),
    RAC3ITEM.NANO_PAK: RAC3DATATABLE(0x00142CC0, 0),
    RAC3ITEM.WARP_PAD: RAC3DATATABLE(0x00142CBF, 31),
    RAC3ITEM.PDA: RAC3DATATABLE(0x00142CC3, 35),
    RAC3ITEM.CHARGE_BOOTS: RAC3DATATABLE(0x00142CBD, 0),
    RAC3ITEM.MASTER_PLAN: RAC3DATATABLE(0x00142CC2, 0),
    # VidComics
    RAC3ITEM.VIDCOMIC1: RAC3DATATABLE(0x001D554F),
    RAC3ITEM.VIDCOMIC2: RAC3DATATABLE(0x001D5551),
    RAC3ITEM.VIDCOMIC3: RAC3DATATABLE(0x001D5552),
    RAC3ITEM.VIDCOMIC4: RAC3DATATABLE(0x001D5550),
    RAC3ITEM.VIDCOMIC5: RAC3DATATABLE(0x001D5553),
    # Todo: Infobots
}
