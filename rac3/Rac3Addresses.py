...
RAC3_DATA_TABLE: dict[str, RAC3DATA] = {
    # Weapons
    # 0x01
    RAC3ITEM.HELI_PACK: RAC3ITEMDATA(0x02),  # Unused
    RAC3ITEM.THRUSTER_PACK: RAC3ITEMDATA(0x03),  # Unused
    RAC3ITEM.HYDRO_PACK: RAC3ITEMDATA(0x04),  # Unused
    RAC3ITEM.MAP_O_MATIC: RAC3ITEMDATA(0x05),
    RAC3ITEM.COMMANDO_SUIT: RAC3ITEMDATA(0x06),  # Unused
    RAC3ITEM.BOLT_GRABBER: RAC3ITEMDATA(0x07),
    ...
    RAC3ITEM.HYPERSHOT: RAC3ITEMDATA(0x0B),
    RAC3ITEM.MORPH_O_RAY: RAC3ITEMDATA(0x0C),  # Unused
    RAC3ITEM.GRAV_BOOTS: RAC3ITEMDATA(0x0D),
    RAC3ITEM.GRIND_BOOTS: RAC3ITEMDATA(0x0E),  # Unused
    RAC3ITEM.GLIDER: RAC3ITEMDATA(0x0F),  # Unused
    RAC3ITEM.PLASMA_COIL: RAC3ITEMDATA(0x10, 1, 15),
    RAC3ITEM.LAVA_GUN: RAC3ITEMDATA(0x11, 1, 150),
    RAC3ITEM.REFRACTOR: RAC3ITEMDATA(0x12),
    RAC3ITEM.BOUNCER: RAC3ITEMDATA(0x13, 1, 10),
    RAC3ITEM.HACKER: RAC3ITEMDATA(0x14),
    RAC3ITEM.MINI_TURRET: RAC3ITEMDATA(0x15, 1, 10),
    RAC3ITEM.SHIELD_CHARGER: RAC3ITEMDATA(0x16, 60, 3),
    # 0x17 Set on new file, Empty Hand
    RAC3ITEM.HELMET: RAC3ITEMDATA(0x18),  # Unused
    # 0x19 SEVERE CRASH RISK
    RAC3ITEM.BOX_BREAKER: RAC3ITEMDATA(0x1A),
    RAC3ITEM.HASH: RAC3ITEMDATA(0x1B),  # Unused
    RAC3ITEM.GRIND_BOOTS_2: RAC3ITEMDATA(0x1C),  # Unused
    RAC3ITEM.CHARGE_BOOTS: RAC3ITEMDATA(0x1D),
    RAC3ITEM.TYHRRA_GUISE: RAC3ITEMDATA(0x1E),
    RAC3ITEM.WARP_PAD: RAC3ITEMDATA(0x1F),
    RAC3ITEM.NANO_PAK: RAC3ITEMDATA(0x20),
    # 0x21 SEVERE CRASH RISK
    RAC3ITEM.MASTER_PLAN: RAC3ITEMDATA(0x22),
    RAC3ITEM.PDA: RAC3ITEMDATA(0x23),
    RAC3ITEM.THIRD_PERSON: RAC3ITEMDATA(0x24),
    RAC3ITEM.FIRST_PERSON: RAC3ITEMDATA(0x25),
    RAC3ITEM.LOCK_STRAFE: RAC3ITEMDATA(0x26),
    RAC3ITEM.SHOCK_BLASTER: RAC3ITEMDATA(0x27, 40, 30),
    ...
    RAC3ITEM.SHOCK_CANNON_V7: RAC3ITEMDATA(0x2D, 1400, 55, 11000),
    RAC3ITEM.SHOCK_CANNON_V8: RAC3ITEMDATA(0x2E, 2100, 60, 26000),
    RAC3ITEM.N60_STORM: RAC3ITEMDATA(0x2F, 150, 150),
    ...
    RAC3ITEM.N60_HURRICANE_V7: RAC3ITEMDATA(0x35, 5000, 350, 18300),
    RAC3ITEM.N60_HURRICANE_V8: RAC3ITEMDATA(0x36, 6000, 400, 40800),
    RAC3ITEM.INFECTOR: RAC3ITEMDATA(0x37, 180, 15),
    ...
    RAC3ITEM.INFECTO_BOMB_V6: RAC3ITEMDATA(0x3C, 4600, 20),
    RAC3ITEM.INFECTO_BOMB_V7: RAC3ITEMDATA(0x3D, 9600, 25, 13800),
    RAC3ITEM.INFECTO_BOMB_V8: RAC3ITEMDATA(0x3E, 15600, 30, 18800),
    RAC3ITEM.ANNIHILATOR: RAC3ITEMDATA(0x3F, 500, 20),
    ...
    RAC3ITEM.DECIMATOR_V7: RAC3ITEMDATA(0x45, 4000, 28, 22400),
    RAC3ITEM.DECIMATOR_V8: RAC3ITEMDATA(0x46, 5000, 30, 37400),
    RAC3ITEM.SPITTING_HYDRA: RAC3ITEMDATA(0x47, 200, 15),
    RAC3ITEM.SPITTING_HYDRA_V2: RAC3ITEMDATA(0x48, 240, 15, 300),
    RAC3ITEM.SPITTING_HYDRA_V3: RAC3ITEMDATA(0x49, 280, 15, 900),
    RAC3ITEM.SPITTING_HYDRA_V4: RAC3ITEMDATA(0x4A, 320, 15, 1200),
    RAC3ITEM.TEMPEST_V5: RAC3ITEMDATA(0x4B, 400, 15, 2400),
    RAC3ITEM.TEMPEST_V6: RAC3ITEMDATA(0x4C, 3200, 15),
    RAC3ITEM.TEMPEST_V7: RAC3ITEMDATA(0x4D, 5400, 18, 17400),
    RAC3ITEM.TEMPEST_V8: RAC3ITEMDATA(0x4E, 6000, 20, 39900),
    RAC3ITEM.DISC_BLADE: RAC3ITEMDATA(0x4F, 500, 25),
    ...
    RAC3ITEM.MULTI_DISC_V7: RAC3ITEMDATA(0x55, 5600, 28, 22100),
    RAC3ITEM.MULTI_DISC_V8: RAC3ITEMDATA(0x56, 8400, 30, 37100),
    RAC3ITEM.AGENTS_OF_DOOM: RAC3ITEMDATA(0x57, 240, 6),
    ...
    RAC3ITEM.AGENTS_OF_DREAD_V7: RAC3ITEMDATA(0x5D, 10000, 10, 13500),
    RAC3ITEM.AGENTS_OF_DREAD_V8: RAC3ITEMDATA(0x5E, 12000, 12, 26000),
    RAC3ITEM.RIFT_INDUCER: RAC3ITEMDATA(0x5F, 1000, 8),
    ...
    RAC3ITEM.RIFT_RIPPER_V7: RAC3ITEMDATA(0x65, 5000, 14, 27400),
    RAC3ITEM.RIFT_RIPPER_V8: RAC3ITEMDATA(0x66, 6000, 16, 49900),
    RAC3ITEM.HOLO_SHIELD: RAC3ITEMDATA(0x67, 200, 8),
    ...
    RAC3ITEM.ULTRA_SHIELD_V7: RAC3ITEMDATA(0x6D, 1500, 12, 7700),
    RAC3ITEM.ULTRA_SHIELD_V8: RAC3ITEMDATA(0x6E, 2000, 14, 15200),
    RAC3ITEM.FLUX_RIFLE: RAC3ITEMDATA(0x6F, 300, 10),
    ...
    RAC3ITEM.SPLITTER_RIFLE_V7: RAC3ITEMDATA(0x75, 7000, 18, 10400),
    RAC3ITEM.SPLITTER_RIFLE_V8: RAC3ITEMDATA(0x76, 8400, 20, 22900),
    RAC3ITEM.NITRO_LAUNCHER: RAC3ITEMDATA(0x77, 200, 8),
    ...
    RAC3ITEM.NITRO_ERUPTOR_V7: RAC3ITEMDATA(0x7D, 5000, 14, 10100),
    RAC3ITEM.NITRO_ERUPTOR_V8: RAC3ITEMDATA(0x7E, 6000, 16, 22600),
    RAC3ITEM.PLASMA_WHIP: RAC3ITEMDATA(0x7F, 40, 25),
    ...
    RAC3ITEM.QUANTUM_WHIP_V7: RAC3ITEMDATA(0x85, 1800, 55, 13300),
    RAC3ITEM.QUANTUM_WHIP_V8: RAC3ITEMDATA(0x86, 2400, 60, 28300),
    RAC3ITEM.SUCK_CANNON: RAC3ITEMDATA(0x87, 200),
    ...
    RAC3ITEM.VORTEX_CANNON_V7: RAC3ITEMDATA(0x8D, 5000, xp=7000),
    RAC3ITEM.VORTEX_CANNON_V8: RAC3ITEMDATA(0x8E, 6000, xp=14500),
    RAC3ITEM.QWACK_O_RAY: RAC3ITEMDATA(0x8F, 1000),
    ...
    RAC3ITEM.QWACK_O_BLITZER_V7: RAC3ITEMDATA(0x95, 5000, xp=26000),
    RAC3ITEM.QWACK_O_BLITZER_V8: RAC3ITEMDATA(0x96, 6000, xp=41000),
    RAC3ITEM.RY3N0: RAC3ITEMDATA(0x97, 6000, 25),
    ...
    # Gadgets
    # VidComics
    RAC3ITEM.VIDCOMIC1: RAC3ITEMDATA(address=0x001D554F),
    RAC3ITEM.VIDCOMIC2: RAC3ITEMDATA(address=0x001D5551),
    RAC3ITEM.VIDCOMIC3: RAC3ITEMDATA(address=0x001D5552),
    RAC3ITEM.VIDCOMIC4: RAC3ITEMDATA(address=0x001D5550),
    RAC3ITEM.VIDCOMIC5: RAC3ITEMDATA(address=0x001D5553),
    # Infobots
...
ITEM_NAME_FROM_ID: dict[int, str] = {
    0x02: RAC3ITEM.HELI_PACK,
    0x03: RAC3ITEM.THRUSTER_PACK,
    0x05: RAC3ITEM.MAP_O_MATIC,
    0x07: RAC3ITEM.BOLT_GRABBER,
    0x09: RAC3ITEM.WRENCH,
    0x0B: RAC3ITEM.HYPERSHOT,
    0x0D: RAC3ITEM.GRAV_BOOTS,
    0x10: RAC3ITEM.PLASMA_COIL,
    0x11: RAC3ITEM.LAVA_GUN,
    0x12: RAC3ITEM.REFRACTOR,
    0x13: RAC3ITEM.BOUNCER,
    0x14: RAC3ITEM.HACKER,
    0x15: RAC3ITEM.MINI_TURRET,
    0x16: RAC3ITEM.SHIELD_CHARGER,
    0x1A: RAC3ITEM.BOX_BREAKER,
    0x1D: RAC3ITEM.CHARGE_BOOTS,
    0x1E: RAC3ITEM.TYHRRA_GUISE,
    0x1F: RAC3ITEM.WARP_PAD,
    0x20: RAC3ITEM.NANO_PAK,
    0x22: RAC3ITEM.MASTER_PLAN,
    0x23: RAC3ITEM.PDA,
    0x27: RAC3ITEM.SHOCK_BLASTER,
    0x2F: RAC3ITEM.N60_STORM,
    0x37: RAC3ITEM.INFECTOR,
    0x3F: RAC3ITEM.ANNIHILATOR,
    0x47: RAC3ITEM.SPITTING_HYDRA,
    0x4F: RAC3ITEM.DISC_BLADE,
    0x57: RAC3ITEM.AGENTS_OF_DOOM,
    0x5F: RAC3ITEM.RIFT_INDUCER,
    0x67: RAC3ITEM.HOLO_SHIELD,
    0x6F: RAC3ITEM.FLUX_RIFLE,
    0x77: RAC3ITEM.NITRO_LAUNCHER,
    0x7F: RAC3ITEM.PLASMA_WHIP,
    0x87: RAC3ITEM.SUCK_CANNON,
    0x8F: RAC3ITEM.QWACK_O_RAY,
    0x97: RAC3ITEM.RY3N0,
}
